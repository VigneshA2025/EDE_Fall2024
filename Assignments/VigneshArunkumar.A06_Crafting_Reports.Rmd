...
kables(list(
    kable(summary_PM25, col.names = c('County', "$\\mu g/m^3$"), valign = 't', caption = "Mean Particulates (2.5mm)", digits = 2),
    kable(summary_Ozone, col.names = c('County', "$\\mu g/m^3$"), valgin = 't', caption = "Mean Ozone", digits = 2)))
```
