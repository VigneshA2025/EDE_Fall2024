...
```{r echo=FALSE, fig.height=3, warning=FALSE, fig.cap="Monthly Ozone levels in 2018"}
ozone2018 <- epa_data[epa_data$Year==2018,]

Plot1<- ggplot(ozone2018, aes(x = as.factor(Month)))+
  geom_boxplot(aes(y=Ozone))+
  labs(title = "Monthly Ozone Concentrations (2018)", x = "Month",y = 'Concentrations (ug/m^3)')

Plot1
```

```{r echo=FALSE, fig.height=3, warning=FALSE, fig.cap="Monthly Ozone levels in 2019"}
ozone2019 <- epa_data[epa_data$Year==2019,]

Plot2<- ggplot(ozone2019, aes(x = as.factor(Month)))+
  geom_boxplot(aes(y=Ozone))+
  labs(title = "Monthly Ozone Concentrations (2019)",x = "Month",y = 'Concentrations(ug/m^3)')
